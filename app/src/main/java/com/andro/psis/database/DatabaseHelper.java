package com.andro.psis.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_PESAN = "tb_pesan";
    public static final String COL_ID_BOOK = "id_book";
    public static final String COL_TANDING = "tanding";
    public static final String COL_TRIBUN = "tribun";
    public static final String COL_KURSI = "kursi";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_USER + " (" + COL_USERNAME + " TEXT PRIMARY KEY, " + COL_PASSWORD +
                " TEXT, " + COL_NAME + " TEXT)");
        db.execSQL("create table " + TABLE_PESAN + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_TANDING + " TEXT, " + COL_TRIBUN + " TEXT" + ", " + COL_KURSI + " TEXT)");
        db.execSQL("create table " + TABLE_HARGA + " (" + COL_USERNAME + " TEXT, " + COL_ID_BOOK + " INTEGER, " +
                COL_HARGA_DEWASA + " TEXT, " + COL_HARGA_TOTAL +
                " TEXT, FOREIGN KEY(" + COL_USERNAME + ") REFERENCES " + TABLE_USER
                + ", FOREIGN KEY(" + COL_ID_BOOK + ") REFERENCES " + TABLE_PESAN + ")");
        db.execSQL("insert into " + TABLE_USER + " values ('bagas@gmail.com','bagas','Bagaswara');");
    }
